      ...
      function setWeather(data) {
        ...
        if (!data.name) {
          ...
          if (data.weather[0].main == "Rain" || data.weather[0].main == "Drizzle" || data.weather[0].main == "Thunderstorm") {
            document.getElementById("weather-icon-img").src = "/rain.png"
          } else if (data.weather[0].main == "Clear") {
            document.getElementById("weather-icon-img").src = "/sunny.png"
          } else if (data.weather[0].main == "Clouds") {
            document.getElementById("weather-icon-img").src = "/cloudy.png"
          } else if (data.weather[0].main == "Snow") {
            document.getElementById("weather-icon-img").src = "/snow.png"
          }
        }
      }
