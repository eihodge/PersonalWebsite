      ...
      function setWeather(data) {
        ...
        if (!data.name) {
          ...
          if (data.weather[0].main == "Rain" || data.weather[0].main == "Drizzle" || data.weather[0].main == "Mist") {
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/rain.png";
            ...
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/sunny.png";
            document.getElementById("window").style.backgroundImage = "url(clear.jpeg)";
            document.getElementById("window").style.backgroundSize = "100%";
          } else if (data.weather[0].main == "Clouds") {
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/cloudy.png";
            document.getElementById("window").style.backgroundImage = "url(clouds.webp)";
            document.getElementById("window").style.backgroundSize = "100%";
          } else if (data.weather[0].main == "Snow") {
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/snow.png";
            document.getElementById("window").style.backgroundImage = "url(snow.jpeg)";
            document.getElementById("window").style.backgroundSize = "100%";
          } else if (data.weather[0].main == "Fog") {
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/fog.png";
            document.getElementById("window").style.backgroundImage = "url(fog.jpg)";
            document.getElementById("window").style.backgroundSize = "100%";
          } else if (data.weather[0].main == "Thunderstorm") {
            document.getElementById("weather-icon-img").src = "https://ethanhodge.com/resources/images/weather/thunderstorm.png";
